		...
		<Container 
			...
			<Box>
				...
				<ListItem height={68} width={366} display="flex" alignItems="center">
					...
					<Link color={'#ffffff'} style={{ textDecoration: 'none' }} padding={10} href="/dashboard">
					My Subscriptions
					</Link>
				</ListItem>
				<ListItem height={68} width={366} display="flex" alignItems="center">
				...
				<ListItem height={68} width={366} display="flex" alignItems="center">
					...
					<Link color={'#ffffff'} style={{ textDecoration: 'none' }} padding={10} href="/">
					Promote
					</Link>
				</ListItem>
				</List>
